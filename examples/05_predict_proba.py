...
def predict_proba():
    """Example code: calls .predict_proba(...) on a predictor"""
    ...
    print("\n-- [04] example --")
    print(f"Calling .predict_proba(...) on a predictor identified with: {model_identifier}\n")

    # Call .predict_proba(...) on a predictor
    response, status_code = client.predict_proba(
